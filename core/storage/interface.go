...
// Note: Storage instances should be created directly by the user
// and passed to k1s components via dependency injection.
// This keeps the core package lean and allows modular backend selection.
